...
function SwipeOnly () {
  ...
  return (
    <div>
      ...
      {lastDirection ? <h2 key={lastDirection} className='infoText'>You {lastDirection == 'left' ? 'liked' : 'disliked'} </h2> : <h2 className='infoText'>Swipe Only - Swipe a card or press a button to get started!</h2>}
    </div>
  )
}
